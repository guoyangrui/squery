...
public class TreeGenerator {
	  ...
	  public TreeGenerator(String formats) {
	    this(formats, "", new PennTreebankLanguagePack());
	  }

	  /** Make a TreePrint instance with no options specified. */
	  public TreeGenerator(String formats, TreebankLanguagePack tlp) {
	    this(formats, "", tlp);
	  }

	  /** Make a TreePrint instance. This one uses the default tlp headFinder. */
	  public TreeGenerator(String formats, String options, TreebankLanguagePack tlp) {
	   ...
	   */
	  public TreeGenerator(String formatString, String optionsString, TreebankLanguagePack tlp, HeadFinder hf, HeadFinder typedDependencyHF) {
